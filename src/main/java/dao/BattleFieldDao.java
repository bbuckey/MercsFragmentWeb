...
public class BattleFieldDao extends BaseDAO {
	...
	public List getAllBattleFields() {
		return super.getSessionFactory().getCurrentSession()
				.createQuery("from BattleFieldEntity").list();
	}
	...
	public void deleteBattleField(Integer mercId) {
		BattleFieldEntity merc = (BattleFieldEntity) super.getSessionFactory()
				.getCurrentSession().load(BattleFieldEntity.class, mercId);
		if (merc != null) {
	...
	public List getBattleFieldByLevel(Integer levelNumber) {
		return super
				...
				.getCurrentSession()
				.createSQLQuery(
						"select bf.id, bf.LEVEL_NUMBER from base.battefield bf where bf.level_number = :lnumber")
				.addEntity(BattleFieldEntity.class)
				.setParameter("lnumber", levelNumber).list();
	}
