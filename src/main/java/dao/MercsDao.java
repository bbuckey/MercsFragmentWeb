...
public class MercsDao extends BaseDAO {
	...
	public List getAllMercs() {
		return super.getSessionFactory().getCurrentSession()
				.createQuery("from MercEntity").list();
	}
	...
	public void deleteMerc(Integer mercId) {
		MercEntity merc = (MercEntity) super.getSessionFactory()
				.getCurrentSession().load(MercEntity.class, mercId);
		if (merc != null) {
	...
	public MercEntity getMercByID(Integer mercId) {
		MercEntity merc = (MercEntity) super.getSessionFactory()
				.getCurrentSession()
				.createQuery("from MercEntity me where me.id = :meid ")
				.setParameter("meid", mercId).uniqueResult();
		return merc;
	}
