...
public class WeaponsDao extends BaseDAO {
	...
	public List getAllWeapons() {
		return super.getSessionFactory().getCurrentSession()
				.createQuery("from WeaponsEntity").list();
	}
	...
	public void deleteWeapon(Integer weaponsID) {
		WeaponsEntity merc = (WeaponsEntity) super.getSessionFactory()
				.getCurrentSession()
				.createQuery("from WeaponsEntity where id = :meid")
				.setParameter("meid", weaponsID).uniqueResult();
		if (merc != null) {
