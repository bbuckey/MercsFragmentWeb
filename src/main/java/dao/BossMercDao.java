...
public class BossMercDao extends BaseDAO{
	...
	public List getAllBossMercs(){
		return super.getSessionFactory().getCurrentSession().createQuery("from BossMercEntity").list();
	}
	...
	public void deleteBossMerc(Integer mercId){
		BossMercEntity merc = (BossMercEntity) super.getSessionFactory().getCurrentSession().load(BossMercEntity.class, mercId);
		if(merc != null){
	...
	public List getBossMercByBattleFieldID(Integer battleFieldID){
		return super.getSessionFactory().getCurrentSession()
				.createQuery("from BossMercEntity bm where bm.battlefield_id = :bfid").setParameter("bfid", battleFieldID).list();
	}
}
