...
public class ComputerMercsDao extends BaseDAO {
	...
	public List getAllComputerMercs() {
		return super.getSessionFactory().getCurrentSession()
				.createQuery("from ComputerMercsEntity").list();
	}
	...
	public void deleteComputerMercs(Integer mercId) {
		ComputerMercsEntity merc = (ComputerMercsEntity) super
				.getSessionFactory().getCurrentSession()
				.load(ComputerMercsEntity.class, mercId);
		if (merc != null) {
	...
	public List getComputerMercbyBattleFieldID(Integer battleFieldID) {
		return super
				...
				.getCurrentSession()
				.createQuery(
						"from ComputerMercsEntity cm  where cm.battlefieldId = :bfid")
